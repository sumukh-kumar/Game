...
input_rect = pygame.Rect(200,300,335,45)
rectcol_a = pygame.Color('white')              #active
rectcol_p = pygame.Color('lightskyblue3')      #passive
colour = rectcol_p   
active = False
charcount = 0

pbase_font = pygame.font.Font(None, 40)
puser_text = ''
prectcol_a = pygame.Color('white')              #active
prectcol_p = pygame.Color('lightskyblue3')      #passive
pcolour = prectcol_p   
pinput_rect = pygame.Rect(200,600,335,45)   
pactive = False
pcharcount = 0